      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end">
          ...
          <div
            ...
            className="relative z-10 bg-[#141414] rounded-t-3xl shadow-[0_-4px_32px_rgba(0,0,0,0.6)] max-h-[90dvh] overflow-y-auto"
            style={{
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-[#1E1E1E] border border-[#2A2A2A] text-[#A0A0A0] hover:text-white transition-colors duration-200"
              aria-label="Fermer"
            >
            ...
            <div className="px-4 pt-4 pb-2 space-y-1.5">
              ...
              <span
                className="block text-lg font-extrabold tabular-nums pt-1"
                style={{ color: 'var(--brand, #FF6B35)' }}
              >
                {product.price.toFixed(2)} €
              </span>
            ...
            <div className="px-4 py-3 flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-9 h-9 rounded-xl flex items-center justify-center bg-[#1E1E1E] border border-[#2A2A2A] text-white font-bold text-lg hover:bg-[#2A2A2A] transition-all duration-200 active:scale-90"
                ...
                <button
                  ...
                  className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-lg transition-all duration-200 active:scale-90 hover:brightness-110"
                  style={{ backgroundColor: 'var(--brand, #FF6B35)' }}
            ...
            <div className="px-4 pb-3">
              <textarea
                ...
                placeholder="Ex: sans oignon, allergie aux arachides..."
                rows={2}
                className="w-full rounded-xl bg-[#1E1E1E] border border-[#2A2A2A] text-white placeholder:text-[#555] text-sm px-3 py-2.5 resize-none focus:outline-none focus:border-[rgba(255,255,255,0.15)] transition-colors duration-200"
              />
            </div>
            ...
            <div className="px-4 pb-8 pt-1">
              <button
                ...
                className="w-full rounded-2xl py-4 text-white font-bold text-base transition-all duration-200 active:scale-[0.98] hover:brightness-110 shadow-[0_4px_24px_rgba(0,0,0,0.4)]"
                style={{ backgroundColor: 'var(--brand, #FF6B35)' }}
              >
